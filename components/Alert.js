...
const Alert = ({setOpen}) => {
    return (
        <div className="relative -ml-16 mt-2 flex flex-col sm:flex-row sm:items-center bg-white shadow rounded-md py-5 pl-6 pr-8 sm:pr-6">
            ...
            <div className="text-sm tracking-wide text-gray-500 mt-4 sm:mt-0 sm:ml-4">Your successfully uploaded to IPFS</div>
            <div className="absolute sm:relative sm:top-auto sm:right-auto ml-auto right-4 top-4 text-gray-400 hover:text-gray-800 cursor-pointer" onClick = {e => setOpen(false)}>
