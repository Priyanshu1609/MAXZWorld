    ...
    <div>
        {isAuthenticated ? (
            <form onSubmit={createBrand} className="h-auto p-10 border-2 m-5 rounded-lg inline-block ">
                <h1 className="text-center font-bold">Budget </h1>
                <p>Fill in the required details :</p>
                <div className="mb-6">
                    <label htmlFor="brandName" className="block mb-2 text-sm font-medium text-gray-900 ">Budget Per Day</label>
                    <input onChange={changeHandler} type="text" name="brandName" id="brandName" className="shadow-sm bg-gray-50 block w-full p-2.5 border text-sm rounded-lg outline-none" placeholder="10USDC" required="" />
                </div>
                <div className="mb-6">
                    <label htmlFor="contractAddress" className="block mb-2 text-sm font-medium text-gray-900 ">Target Reach</label>
                    <input  onChange={changeHandler} type="text" name="contractAddress" id="contractAddress" className="shadow-sm bg-gray-50 block w-full p-2.5 border text-sm rounded-lg outline-none" placeholder="Phillipines" required="" />
                </div>
                ...
                <div className="mb-6 mt-4">
                    <label htmlFor="contractAddress" className="block mb-2 text-sm font-medium text-gray-900 ">Todal budget</label>
                    <input  onChange={changeHandler} type="text" name="contractAddress" id="contractAddress" className="shadow-sm bg-gray-50 block w-full p-2.5 border text-sm rounded-lg outline-none" placeholder="20 USDC" required="" />
                </div>
